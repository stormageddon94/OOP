        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (rowCounter % 2 == 0)
                {
                    ...
                    var foodType = Type.GetType($"WildFarm.{foodName}");
                    ...
                    if (animalType == "Tiger")
                    {
                        ...
                        var tiger = new Tiger(animalName, animalWeight, foodQuantity, livingRegion, breed);
                        tiger.AskForFood();
                    ...
                    else if (animalType == "Cat")
                    {
                        var livingRegion = animalInfo[3];
                        var breed = animalInfo[4];
                        var cat = new Cat(animalName, animalWeight, foodQuantity, livingRegion, breed);
                        cat.AskForFood();
                    ...
                    else if (animalType == "Owl")
                    {
                        ...
                        var owl = new Owl(animalName, animalWeight, foodQuantity, wingSize);
                        owl.AskForFood();
                    ...
                    {
                        var wingSize = double.Parse(animalInfo[3]);
                        var hen = new Hen(animalName, animalWeight, foodQuantity, wingSize);
                        hen.AskForFood();
                    ...
                    {
                        var livingRegion = animalInfo[3];
                        var mouse = new Mouse(animalName, animalWeight, foodQuantity, livingRegion);
                        mouse.AskForFood();
                    ...
                    {
                        var livingRegion = animalInfo[3];
                        var dog = new Dog(animalName, animalWeight, foodQuantity, livingRegion);
                        dog.AskForFood();
